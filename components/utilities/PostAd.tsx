  ...
  return (
    <div className="post-card bg-neutral-100 font-inter dark:bg-neutral-900 border border-neutral-200  dark:border-neutral-700 rounded-[20px] overflow-hidden shadow-lg">
      ...
      <div className="w-full h-auto px-4 mb-4">
        <video
          className="rounded-[19px] object-cover w-full max-w-full max-h-[600px]"
          src="/videos/add.mp4"
          controls
          playsInline
          preload="metadata"
      ...
      <div className="px-4 pb-4">
        <div className="text-sm leading-6 text-neutral-700 border-t border-neutral-300 dark:border-neutral-700 dark:text-neutral-300">
          ...
          <p className="flex  text-neutral-700 dark:text-neutral-300 text-md">
